...
with check (is_read=false and char_length(trim(name)) between 1 and 120 and char_length(trim(email)) between 3 and 254 and char_length(trim(message)) between 1 and 5000);
