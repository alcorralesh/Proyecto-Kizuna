...
function launch(id,{fromHistory=false}={}){
  ...
  if(id==='whatsapp'){
    appContent.innerHTML='<iframe class="whatsapp-frame" title="Conversaciones recuperadas con Alberto" src="../conversacion/index.html?embedded=1&v=20260802-whatsapp-chat-list01"></iframe>';
  }else{
