...
create table if not exists public.expedient_activity_log (
  ...
  event_type text not null check (event_type in ('login', 'logout', 'document_confirmed', 'comic_page_read', 'supplementary_file_consulted', 'expedient_reset', 'legal_terms_accepted', 'legal_terms_reset', 'onboarding_completed', 'onboarding_skipped', 'onboarding_reset')),
  document_id text,
...
alter table public.expedient_activity_log
  ...
  check (event_type in ('login', 'logout', 'document_confirmed', 'comic_page_read', 'supplementary_file_consulted', 'expedient_reset', 'legal_terms_accepted', 'legal_terms_reset', 'onboarding_completed', 'onboarding_skipped', 'onboarding_reset'));
