...
Deno.serve(async (request) => {
  ...
  if (action === 'reset-progress') {
    ...
    const cleanState = {
      ...
      comicReadPages: [],
      alt00Discovered: false,
      alt00DiscoveredAt: null,
      alt00Completed: false,
      alt00CompletedAt: null,
      alt00LastPage: 1,
      earlyAccessVersion: 1,
      earlyAccessShownAt: null,
      earlyAccessAcknowledgedAt: null,
      legalAccepted: false,
