...
const safeState=state=>({read:[],mailRead:0,finalFileSeen:false,finalAlertShown:false,completed:false,finalFlowStage:'',legalAccepted:false,legalAcceptedAt:null,legalVersion:1,...(state||{})});
