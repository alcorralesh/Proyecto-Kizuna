...
const openRecoveredDeviceFromAr06=()=>{
  ...
  document.querySelector('#doc-body').innerHTML=`<section class="recovered-device-embed" aria-label="Dispositivo clonado SM-G991B"><iframe src="../dispositivo-recuperado/index.html?embedded=1&v=20260802-whatsapp-chat-list01" title="Dispositivo clonado SM-G991B" loading="eager" allow="autoplay; fullscreen"></iframe></section>`;
