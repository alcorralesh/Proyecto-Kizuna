...
const mobileCaseHeaderStyle=document.createElement('style');mobileCaseHeaderStyle.textContent=`@media(max-width:600px){.dashboard{overflow-x:hidden}.dashboard>header{min-height:58px;padding:max(6px,env(safe-area-inset-top)) 9px 6px!important;gap:8px;border-bottom:1px solid #c4b79f}.dashboard>header .access-brand{min-width:0;gap:7px}.dashboard>header .access-brand img{width:36px;height:36px}.dashboard>header .access-brand span{overflow:hidden;font-size:10px;letter-spacing:.12em;text-overflow:ellipsis;white-space:nowrap}.dashboard>header .access-brand small{display:none}.dashboard>header .header-actions{position:relative;flex:0 0 auto;margin-left:auto;gap:0!important;overflow:visible;border:1px solid #c2b59d;background:#eee4d2;box-shadow:3px 3px 0 #8a76531a}.dashboard>header .header-actions .sync-clock{display:none!important}.dashboard>header .header-actions button{position:relative;display:grid!important;grid-template-rows:18px 9px;place-items:center;width:43px!important;min-width:43px!important;height:44px!important;margin:0!important;padding:5px 3px 4px!important;border:0!important;border-left:1px solid #c2b59d!important;border-radius:0!important;background:transparent!important;color:#26312d!important;box-shadow:none!important;line-height:1!important}.dashboard>header .header-actions button:first-of-type{border-left:0!important}.dashboard>header .header-actions button span{display:block;font:16px/1 var(--serif);transform:none}.dashboard>header .header-actions button b{display:block!important;font:500 6px/1 var(--mono)!important;letter-spacing:.06em;text-transform:uppercase}.dashboard>header #sound-toggle.active{color:#7e1b19!important;background:#e4d3b9!important}.dashboard>header #mailbox-toggle.has-unread{color:#fff!important;background:#7e1b19!important}.dashboard>header #mailbox-toggle i{position:absolute;right:2px;top:2px;display:grid;place-items:center;min-width:14px;height:14px;padding:0 3px;border:1px solid #f6f0e2;border-radius:8px;background:#202726;color:#fff;font:6px/1 var(--mono);font-style:normal}.dashboard>header #mailbox-toggle i[hidden]{display:none}.dashboard>header #return-public-site span{font-size:18px}.dashboard>header #exit{color:#7e1b19!important}.dashboard>header #exit span{font-size:17px}.dashboard>header .header-actions button:active{background:#dcd0bb!important;transform:translateY(1px)}.case-head{top:57px!important}}@media(max-width:390px){.dashboard>header .access-brand span{display:none}.dashboard>header .header-actions button{width:42px!important;min-width:42px!important}}`;document.head.appendChild(mobileCaseHeaderStyle);
