(() => {
  ...
  const css = `
    ...
    *{box-sizing:border-box}button,input{font:inherit}button{color:inherit}button:focus-visible,input:focus-visible,[tabindex]:focus-visible{outline:2px solid var(--gold);outline-offset:4px}
    ...
    @media(max-width:680px){.console{min-height:650px}header{padding:14px}.node{display:none}.stage{min-height:540px;padding:14px 10px 53px}.accession,.consent,.correspondence,.album,.compare,.signature,.timeline,.cipher,.classify,.datepress,.validation{grid-template-columns:1fr;gap:15px}.index-card,.letter,.photo,.update-module,.classify-card,.act{justify-self:center}.index-card{width:205px;min-height:155px}.master-file{min-height:190px}.clauses{min-height:210px;padding:20px}.sleeve{min-height:185px}.letter{width:190px;min-height:180px}.album{gap:12px}.photo{width:175px}.album-page{min-height:190px}.compare-view{min-height:215px}.compare-control{grid-template-columns:1fr auto}.signature{gap:10px}.sign-sheet{min-height:220px;padding:20px}.timeline-track{min-height:185px}.cipher-core{min-height:190px}.chronology{padding-top:0}.date-cards{grid-template-columns:1fr}.date-card{min-height:82px}.chrono-packet{position:relative;left:auto;top:auto;width:100%;margin-bottom:10px}.integrity{grid-template-columns:1fr}.integrity-doc{min-height:220px}.classify-card{width:190px;min-height:140px}.datepress{gap:12px}.act{width:185px;min-height:160px}.press{min-height:190px}.validation{gap:10px}.success-mark{width:125px;height:125px}.readout{grid-template-columns:1fr auto}}
